...
A backend system for smart inventory and order management built with Node.js, TypeScript, Express, MongoDB, and Socket.IO. This project is designed to support inventory tracking, order workflows, user management, notifications, and real-time communication.
